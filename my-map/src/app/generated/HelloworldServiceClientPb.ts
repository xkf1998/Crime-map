...
export class GreeterClient {
  ...
  methodDescriptorSayHello = new grpcWeb.MethodDescriptor(
    ...
    helloworld_pb.HelloResponse,
    (request: helloworld_pb.HelloRequest) => {
      return request.serializeBinary();
    },
    helloworld_pb.HelloResponse.deserializeBinary
  );

  sayHello(
    request: helloworld_pb.HelloRequest,
    metadata: grpcWeb.Metadata | null): Promise<helloworld_pb.HelloResponse>;

  sayHello(
    request: helloworld_pb.HelloRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
      response: helloworld_pb.HelloResponse) => void): grpcWeb.ClientReadableStream<helloworld_pb.HelloResponse>;
